class SceneTwo extends Phaser.Scene {
  ...
  create() {
    ...
    this.enemyStats = new EnemyStats(100, 10);
    this.disciple = this.add.sprite(790, 175, 'disciple', 0);
    this.disciple.setScale(2.5);
    this.disciple.anims.play(enemyFight['key']);
    let discipleHealth = this.disciple.health = this.enemyStats.health;
    this.discipleHealthBox = this.add.graphics();
    ...
    this.discipleHealthBar.fillRect(760, 255, 90 * (discipleHealth/100), 15);
